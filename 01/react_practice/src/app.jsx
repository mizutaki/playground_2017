    ...
    render: function() {
        ...
        return (
            <div id={this.props.divId} onDrop={dragDrop.drop} onDragOver={dragDrop.dragOver}>
                <CreateButton buttonId={this.props.buttonId} onCreateTextArea={this.props.onCreateTextArea} parentId={this.props.divId}/> {textarea}
            </div>
        );
    }
});
...
var CreateButton = React.createClass({
    ...
    render: function() {
        return (<input id={this.props.buttonId} className="button" type="button" value="作成" onClick={this._onCreateTextArea}/>)
    }
});
...
var TextArea = React.createClass({
    ...
    onChangeText(e) {
        ...
        let parentElementId = e.target.parentNode.id;
    ...
    render: function() {
        return (<textarea id={this.props.id} value={this.state.value} draggable="true" onChange={this.onChangeText} onDragStart={dragDrop.dragStart} onDragLeave={dragDrop.dragLeave}/>)
    }
});
